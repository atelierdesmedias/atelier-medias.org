...
module.exports = {
   ...
   */
  dotEnv: Object.assign({}, require('./default.properties').dotEnv, {
    ...
    WP_URL:
      'http://localhost/atelier-des-medias/atelier-medias.org/trunk/dist/public',

    // Meme URL que WP url avec "/wordpress" à la fin
    WP_SITEURL:
      'http://localhost/atelier-des-medias/atelier-medias.org/trunk/dist/public/wordpress',
